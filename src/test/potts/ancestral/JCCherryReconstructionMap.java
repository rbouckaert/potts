...
public class JCCherryReconstructionMap extends Runnable {
	...
	final public Input<Boolean> useAminoAcidInput = new Input<>("useAminoAcid", "flag to use Amino Acids with WAG instead of Nucleotides with Jukes Cantor", true);
...
//                seqProbs += ";";
	...
	public void run() throws Exception {
        double [][] scores = useAminoAcidInput.get() ? calcRootStateProbsAA() : calcRootStateProbs();
